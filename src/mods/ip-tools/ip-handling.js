class IPGrabberManager extends Module {
    ...
    createAddressContainer(unhashedAddress, hashedAddress, previousHashedAddresses, showData, seenTimes) {
        ...
        this.removeElementsByClass("logitem")
        const innerLogBox = document.getElementById("message-area");
        ...
        innerLogBox.prepend(this.ipToggleButton.get(0));
        innerLogBox.prepend(this.ipGrabberDiv);
        innerLogBox.prepend(seenBeforeDiv);
